...
<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active"><a href="{{route('admin.languages')}}"><i class="la la-mouse-pointer"></i><span
                class="menu-title" data-i18n="nav.add_on_drag_drop.main">الللغات</span>
                <span
                    class="badge badge badge-info badge-pill float-right mr-2">{{get_language_number()}}</span>
              
              </a>
            </li>

            <li class="nav-item"><a href="{{route('admin.maincatagory')}}"><i class="la la-home"></i>
                <span class="menu-title" data-i18n="nav.dash.main">الاقسام</span>
                <span
                    class="badge badge badge-info badge-pill float-right mr-2">{{get_mainCatagory_number()}}</span>
            </a>
            ...
            <li class="nav-item"><a href="{{route('vendor.index')}}"><i class="la la-group"></i>
                <span class="menu-title" data-i18n="nav.dash.main">التجار </span>
                <span
                    class="badge badge badge-danger badge-pill float-right mr-2">{{vendors_number( )}}</span>
            </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href=""
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
            ...
            <li class="nav-item"><a href="{{route('subcatagory.index')}}"><i class="la la-male"></i>
                <span class="menu-title" data-i18n="nav.dash.main">الاقسام الفرعية   </span>
                <span
                    class="badge badge badge-success badge-pill float-right mr-2">{{get_number_subcatagory()}}</span>
            </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href=""
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
            ...
            <li class="nav-item"><a href="{{route('product.index')}}"><i class="la la-male"></i>
