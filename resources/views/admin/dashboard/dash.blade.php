...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('vendors/css/charts/chartist-plugin-tooltip.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('vendors/css/forms/toggle/bootstrap-switch.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css-rtl/pages/chat-application.css')}}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('css-rtl/core/menu/menu-types/vertical-menu.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="   {{asset('vendors/css/extensions/datedropper.min.css')}}">
    <link rel="stylesheet" type="text/css" href="  {{asset('vendors/css/extensions/timedropper.min.css')}}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('css-rtl/style-rtl.css')}}">
    <!-- END Custom CSS-->
...
<body class="vertical-layout vertical-menu 2-columns  @if(Request::is('   users/tickets/reply*')) chat-application @endif menu-expanded fixed-navbar"
...
<!-- BEGIN VENDOR JS-->
<script src="   vendors/js/tables/datatable/datatables.min.js"
        type="text/javascript"></script>
<script src="   vendors/js/tables/datatable/dataTables.buttons.min.js"
        type="text/javascript"></script>

<script src="   vendors/js/forms/toggle/bootstrap-switch.min.js"
        type="text/javascript"></script>
<script src="   vendors/js/forms/toggle/bootstrap-checkbox.min.js"
        type="text/javascript"></script>
...
<script src="   vendors/js/charts/echarts/echarts.js" type="text/javascript"></script>

<script src="   vendors/js/extensions/datedropper.min.js" type="text/javascript"></script>
<script src="   vendors/js/extensions/timedropper.min.js" type="text/javascript"></script>

<script src="   vendors/js/forms/icheck/icheck.min.js" type="text/javascript"></script>
<script src="   js/scripts/pages/chat-application.js" type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN MODERN JS-->
...
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="   js/scripts/pages/dashboard-crypto.js" type="text/javascript"></script>


<script src="   js/scripts/tables/datatables/datatable-basic.js"
        type="text/javascript"></script>
<script src="   js/scripts/extensions/date-time-dropper.js" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
